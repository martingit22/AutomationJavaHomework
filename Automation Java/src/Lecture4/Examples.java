...
//        testBreakStatement();
    ...
    public static void testAssignmentOperators() {
        ...
        // Primer za operator za prisvoqvane (=)
        int result = a + b;
        System.out.println("result = a + b: " + result); // 30

        // Primer za += operator
        result += 5; // result = result + 5
        System.out.println("result += 5: " + result); // 35

        // Primer za -= operator
        result -= 10; // result = result - 10
        System.out.println("result -= 10: " + result); // 25

        // Primer za *= operator
        result *= 2; // result = result * 2
        System.out.println("result *= 2: " + result); // 50

        // Primer za /= operator
        result /= 5; // result = result / 5
        System.out.println("result /= 5: " + result); // 10

        // Primer za %= operator
        result %= 3; // result = result % 3
        System.out.println("result %= 3: " + result); // 1
    }
